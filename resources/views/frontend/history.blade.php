                        ...
                        <table class="table table-borderless" style="table-layout: fixed !important;">
                            ...
                            <tbody>
                                ...
                                @foreach ($order->orderDetails as $item)
                                    @php $sum = $item->quantity * $item->product->product_price; @endphp
                                    <tr>
                                        ...
                                        <td style="width: 200px !important;"><a
                                            ...
                                            <span>{{ $item->product->product_name }}</span> </td>
                                    ...
                                    <td colspan="4">
                                        @if (!$order->slip)
                                            <form action="{{ route('upload.slip') }}" method="post"
                                                ...
                                                <a href="{{ route('transaction.cancel',['order' => $order->id]) }}" class="btn btn-primary">Cancel</a> {{-- cancel order user --}}
                                            </form>
                                        @endif
                                    </td>
                                </tr>
